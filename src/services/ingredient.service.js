...
module.exports = {
    ...
    async createIngedientsCategory(name, restaurantId) {
...
async findRestauarantsIngredients(restaurantId) {
...
return item;
    ...
    throw new Error(
        `Failde to update ingredient stoke status with ID ${id}: ${error.message}`
    );
}
