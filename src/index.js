...
const adminCatgoryRoutes = require("./routes/adminCategoryRoutes.js")
app.use("/api/admin/category", adminCatgoryRoutes)


const adminIngredientsRoutes = require("./routes/adminCategoryRoutes.js");
